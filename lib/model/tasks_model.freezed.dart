...
class _$_TasksModel implements _TasksModel {
  ...
  @override
  String toString() {
    return 'TasksModel(id: $id, userId: $userId, taskListName: $taskListName, title: $title, description: $description, taskStatus: $taskStatus, isCompleted: $isCompleted, publishDate: $publishDate, isFavourite: $isFavourite, isSelected: $isSelected)';
  }
...
abstract class _TasksModel implements TasksModel {
  const factory _TasksModel(
      ...
      final DateTime? publishDate,
      final bool? isFavourite,
      final bool? isSelected}) = _$_TasksModel;
